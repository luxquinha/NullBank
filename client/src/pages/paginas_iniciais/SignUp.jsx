    ...
    return(
        <div className="w-screen h-screen flex flex-row">
            ...
            <div className="flex flex-col items-center w-full">
                ...
                {/* Parte do formulário */}
                <div className="w-[90%] h-[90%] px-4 py-2 flex flex-col items-start flex-wrap text-zinc-400 text-medium">
                    {/* Dados pessoais */}
                    ...
                    <div className="flex flex-row items-center justify-between w-full">
                        ...
                        <div className="flex flex-col w-[25%] mb-8 gap-y-8">
                            <FloatingLabel width={'[90%]'} type={'text'} label={'Bairro'}/>
                            <FloatingLabel width={'[90%]'} type={'password'} label={'Senha'}/>
                        </div>
                    </div>
                    <ButtonWithIcon width={'[50%]'} route={'/home'} icon={seta} content={'Confirmar'}/>
                </div>
            </div>
        </div>
    )
