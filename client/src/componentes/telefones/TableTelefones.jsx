      ...
      <tbody>
        {users.map((item, i) => (
          <tr className="table-light" key={i}>
            <td className="table-light">{item.telefone}</td>
            <td className="table-light">{item.tipo_telefone} </td>
            <td className="table-light">{item.cliente_cpf} </td>
            <td className="table-light cursor-pointer hover:text-cyan-600"><FaEdit onClick={() => handleEdit(item)} /></td>
            <td className="table-light cursor-pointer hover:text-red-600"><FaTrash onClick={() => handleDelete(item.telefone)} /></td>
          </tr>
        ))}
      </tbody>
    </table>
