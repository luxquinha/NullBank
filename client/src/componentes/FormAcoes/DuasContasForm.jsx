...
export default function DuasContaForm(){
    ...
    return(
        <div className="w-[84.5vw] h-screen border flex items-center justify-center">
            <div className="bg-slate-200 shadow-md w-[45vw] h-[40vh] rounded-3xl p-3 flex flex-col items-center justify-around">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="w-full h-full flex flex-col items-center justify-center mt-3">
                    <div className="w-full h-full flex flex-row">
                        <div className="w-full flex flex-col items-center">
                            ...
                            <input type="text" placeholder="R$ 00.00" name="valor" className="w-[10vw] h-[6vh] rounded-2 outline-none p-2 flex font-semibold mb-3 text-center" {...register('valor', {required: "Campo obrigatório"})}/>
                        ...
                        <div className="w-full flex flex-col items-center">
                            ...
                            <input type="password" name="senha" className="w-[10vw] h-[6vh] rounded-2 outline-none p-2 flex font-semibold text-center mb-3" {...register('senha', {required: "Campo obrigatório"})}/>
                            {errors.senha && <ErrorMessage message={errors.senha?.message}/>}
                        </div>
                        <div className="w-full flex flex-col items-center">
                            <label htmlFor="conta" className="text-xl font-semibold tracking-wide text-zinc-500">N° Conta</label>
                            <input type="text" name="conta" className="w-[13vw] h-[6vh] rounded-2 outline-none p-2 flex font-semibold text-center mb-3" {...register('conta_destino', {required: "Campo obrigatório"})}/>
                            {errors.conta_destino && <ErrorMessage message={errors.conta_destino?.message}/>}
                        </div>
                    </div>
